...
o.oder_id,o.amount from customers as c inner join oders as o
...
select c.customer_id , customer_name , o.customer_id,
...
alter table customers rename column customers_id to cid;
select * from customers
